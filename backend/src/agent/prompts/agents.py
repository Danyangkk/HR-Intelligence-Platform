...
判定: 语义=要个人薪酬字段 + 范围=全公司未限定 → payroll_sensitive=true, scope=company → 走 clarify（系统结合 role+confirmed 完成权限决策）
输出: {"intent":"clarify","reject":false,"reasoning":"薪资明细范围过大，需缩小到事业部","payroll_sensitive":true,"payroll_scope":"company","clarify":{"question":"薪资明细查询范围较大，请选择要查看的事业部：","options":[{"label":"杭综部门","value":"杭综部门"},{"label":"杭抖部门","value":"杭抖部门"},{"label":"职能部门","value":"职能部门"}]},"plan":[]}

输入: question="张三的薪资"
判定: 语义=要个人薪酬字段 + 范围=单个人 → payroll_sensitive=true, scope=individual → 归 lookup
输出: {"intent":"lookup","reject":false,"reasoning":"个人薪资查询","payroll_sensitive":true,"payroll_scope":"individual","plan":[
 {"id":"ST1","type":"resolve","goal":"解析张三→工号与组织维度","assigned_agent":"Resolver","retrieve_mode":"structured"},
 {"id":"ST2","type":"retrieve","goal":"取该员工薪资明细","target_l3":["l3-4-1-4"],"retrieve_mode":"structured","assigned_agent":"Retriever"},
 {"id":"ST3","type":"compose","goal":"组织个人薪资答案+溯源","assigned_agent":"Composer"}]}

输入: question="杭抖部门薪资明细"
判定: 语义=要一串个人薪酬记录 + 范围=事业部 → payroll_sensitive=true, scope=bu → 归 list（仍敏感、需权限）
输出: {"intent":"list","reject":false,"reasoning":"事业部级薪资明细，个人记录集合","payroll_sensitive":true,"payroll_scope":"bu","plan":[
 {"id":"ST1","type":"resolve","goal":"解析事业部范围=杭抖部门","assigned_agent":"Resolver","retrieve_mode":"structured"},
 {"id":"ST2","type":"retrieve","goal":"取杭抖部门全员薪资明细","target_l3":["l3-4-1-4"],"retrieve_mode":"structured","assigned_agent":"Retriever"},
 {"id":"ST3","type":"compose","goal":"组织薪资明细答案+溯源","assigned_agent":"Composer"}]}

输入: question="杭抖部门人力成本汇总"
判定: 语义=要一个汇总数（非个人明细） + 范围=事业部 → payroll_sensitive=false → 归 aggregate（正常放行）
输出: {"intent":"aggregate","reject":false,"reasoning":"事业部级聚合金额，非个人明细","payroll_sensitive":false,"plan":[
 {"id":"ST1","type":"resolve","goal":"解析事业部范围=杭抖部门","assigned_agent":"Resolver","retrieve_mode":"structured"},
 {"id":"ST2","type":"retrieve","goal":"取杭抖部门人力成本汇总","target_l3":["l3-4-2-1"],"retrieve_mode":"structured","assigned_agent":"Retriever"},
 {"id":"ST3","type":"compose","goal":"组织成本汇总答案+溯源","assigned_agent":"Composer"}]}

输入: question="李四最近表现怎么样"
输出:
{"intent":"lookup","reject":false,"reasoning":"具体员工近况查询，走结构化取数","payroll_sensitive":false,"plan":[
