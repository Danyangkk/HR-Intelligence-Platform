...
输入: question="离职率为什么涨，是不是和新考核制度有关", history=[]
判定: 归因 + 制度关联 → attribution + 混合取证（structured + rag）
输出:
{"intent":"attribution","reject":false,"reasoning":"组织离职归因并关联考核制度变化","plan":[
 {"id":"ST1","type":"resolve","goal":"解析组织范围与时间窗口","assigned_agent":"Resolver"},
 {"id":"ST2","type":"retrieve","goal":"取证离职率与人事异动","target_l3":["l3-2-5-1","l3-2-3-1"],"retrieve_mode":"structured","assigned_agent":"Retriever"},
 {"id":"ST3","type":"retrieve","goal":"检索半年度考核规则等制度文档","target_l3":["l3-1-3-3"],"retrieve_mode":"rag","assigned_agent":"Retriever"},
 {"id":"ST4","type":"analyze","goal":"归因分析并对照制度变化","assigned_agent":"Analyst"},
 {"id":"ST5","type":"critique","goal":"校验结构化与文档证据均覆盖","assigned_agent":"Critic"},
 {"id":"ST6","type":"compose","goal":"融合数据与制度证据输出结论","assigned_agent":"Composer"}]}
"""
...
- 混合取证场景：本草稿仅覆盖制度/文档部分；结构化数据结论由 compose 阶段与数据证据融合，勿编造数据数字。
- 简体中文，结论清晰可执行。"""
